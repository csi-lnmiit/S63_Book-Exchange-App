<?php
	...
	if(isset($_GET["request"])) {
		...
		if($pts >= 2) {
			header("Location: query.php?request=$bid&to_user=$to_user");
		}
		else {
						        			...
						        			<td>
												...
												<?php
													...
													if(mysqli_num_rows($sha))
														...
														echo "<a href='search.php?request="  . $row['bid'] . "&to_user=" . $row['id'] . "&search_input=" . $input . "'>
